    ...
    while True:
        if ZWOLiveActive:
            ...
            try:
                ...
                print("Please enter a valid exposure time, using ZWO exposure time = 1")
                exptime = 1
    ...
    while True:
        if PILiveActive:
            ...
            try:
                ...
                #messagebox.showerror("Invalid Input", "Please enter a valid exposure time, using exposure time = 1")
                print("Please enter a valid exposure time, using PI exposure time = 1")
                exptime = 1
...
print("Connection to Mount, Main Camera, and Guide Camera is established.")
